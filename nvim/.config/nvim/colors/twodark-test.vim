...
hi clear
let g:colors_name = 'twodark_test'
...
hi Normal guifg=#c3d4db guibg=#181a20 gui=NONE cterm=NONE
hi Visual guifg=NONE guibg=#2f323c gui=NONE cterm=NONE
" hi EndOfBuffer guifg=#5f87d7 guibg=NONE gui=NONE cterm=NONE
hi StatusLine guifg=#c3d4db guibg=#2d313c gui=NONE cterm=NONE
...
hi VertSplit guifg=#43495a guibg=#181a20 gui=NONE cterm=NONE
hi Pmenu guifg=NONE guibg=#3a3f4b gui=NONE cterm=NONE
hi PmenuSel guifg=#181a20 guibg=#6ac0ff gui=NONE cterm=NONE
hi PmenuSbar guifg=NONE guibg=#3a3f4b gui=NONE cterm=NONE
hi PmenuThumb guifg=NONE guibg=#6e7686 gui=NONE cterm=NONE
hi TabLineSel guifg=#c3d4db guibg=#2d313c gui=NONE cterm=NONE
hi TabLine guifg=#c3d4db guibg=#181a20 gui=NONE cterm=NONE
hi TabLineFill guifg=#ff8787 guibg=#181a20 gui=NONE cterm=NONE
...
hi CursorLine guifg=NONE guibg=#242730 gui=NONE cterm=NONE
...
hi LineNr guifg=#3a3f41 guibg=NONE gui=NONE cterm=NONE
...
hi Cursor guifg=#181a20 guibg=#6ac0ff gui=NONE cterm=NONE
...
hi Comment guifg=#40454e guibg=NONE gui=NONE cterm=NONE

hi Constant guifg=#4da3ae guibg=NONE gui=NONE cterm=NONE
hi String guifg=#98c379 guibg=NONE gui=NONE cterm=NONE
hi Character guifg=#e86671 guibg=NONE gui=NONE cterm=NONE
hi Number guifg=#bc8a5b guibg=NONE gui=NONE cterm=NONE
hi Boolean guifg=#bc8a5b guibg=NONE gui=NONE cterm=NONE
hi Float guifg=#bc8a5b guibg=NONE gui=NONE cterm=NONE

hi Identifier guifg=#e86671 guibg=NONE gui=NONE cterm=NONE
hi Function guifg=#6ac0ff guibg=NONE gui=NONE cterm=NONE

hi Statement guifg=#b26cc6 guibg=NONE gui=bold cterm=bold

hi PreProc guifg=#b26cc6 guibg=NONE gui=bold cterm=NONE
hi Macro guifg=#e86671 guibg=NONE gui=bold cterm=NONE

hi Type guifg=#d5c687 guibg=NONE gui=bold cterm=bold

hi Special guifg=#e86671 guibg=NONE gui=NONE cterm=NONE
hi Tag guifg=#98c379 guibg=NONE gui=NONE cterm=NONE
hi Delimiter guifg=#848b98 guibg=NONE gui=NONE cterm=NONE

hi Underlined guifg=#c3d4db guibg=NONE gui=underline cterm=underline

hi Todo guifg=#e86671 guibg=NONE gui=NONE cterm=NONE
hi Error guifg=#e86671 guibg=NONE gui=reverse cterm=reverse

" Tressiter
hi @variable guifg=#c3d4db guibg=NONE gui=NONE cterm=NONE
hi @variable.builtin guifg=#98c379 guibg=NONE gui=NONE cterm=NONE
